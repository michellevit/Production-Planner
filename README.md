...
<a href="https://production-planner.michellef.dev" target="_blank"><img src="https://img.shields.io/badge/Demo-6762a6?style=for-the-badge&color=004596"></a>
<a href="https://www.youtube.com/watch?v=J0YNExrDqck&t=1s&ab_channel=Michelle" target="_blank"><img src="https://img.shields.io/badge/YouTube-Demo-red?style=for-the-badge&logo=youtube&color=FF0000"></a>

![Production Planner Demo](assets/production-planner-demo.gif)
...
- Create a virtual environment in the main folder:
  - Note: you can instead open 'scripts/error_scripts/installing-to-virtual-env.bat', uncomment the relative lines + run it
...
- Option 3:
  ...
  - mysql -u _username (in .env file)_ -p
  - Enter password (in .env file)
  - Select the database: USE Production_Planner_DB
    - To list all the tables in the db: SHOW TABLES;
  - Delete data from each table (and reset index): TRUNCATE TABLE _table name (i.e. api_order)_;
  - Exit MySQL: EXIT;
